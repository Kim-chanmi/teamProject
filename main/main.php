...
<body>
    ...
    <main id="main">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="desc">
                            ...
                            <div class="btn">
                                <a href="../store/store.php">자세히 보기</a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
        ...
        <section id="cardColumn" class="cardColumn__wrap container">
            <div class="cardColumn__inner">
                <div class="card_tit">
                    <h3>매주 업데이트되는 칼럼을 만나보세요!</h3>
                    <a href="../column/columnMain.php"><img src="../html/assets/img/card_arrow.svg" alt="칼럼 전체보기" /></a>
                </div>
                <div class="card__sub">
                    <div class="swiper mySwiper card">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card">
                                    <a class="last__btn" href="../column/columnMain.php">
                                        <figure class="card_img">
                                            <img class="plus__img" src="../html/assets/img/plus_btn.svg"
                                                alt="칼럼 전체보기" />
                                        </figure>
